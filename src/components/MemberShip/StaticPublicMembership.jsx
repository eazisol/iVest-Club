          ...
          <SactionContainer container={false}>
            <div className="card card-border-c w-100 px-1 pt-3  ml-3 mt-5">
              ...
              <div className="mt-2 mx-4">
                <img src={membershipimgpublic1} alt="" className="" />
                <h3 className="mt-5 ">
                ...
                <div className="d-flex">
                  <h5 className=" text-center">
                    <strong className="text-warning warning-bullet text-bold warningDig">
                      02
                    </strong>
                  </h5>
                        ...
                        <Quotations
                          ...
                          text={
                            <span className="pop-font qouteFont ">
                              ...
                              knowledge, resources, and opportunities. They provide
                              a platform for collaboration, networking, and personal
                              growth that can accelerate one's success and elevate
...
export default StaticPublicMembership